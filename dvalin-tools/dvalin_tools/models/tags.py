...
TAGS = {
    TAG_NEW_CHARACTER_INTRO: Tag.NEW_CHARACTER_INTRO,
    TAG_VOICE_ARTIST_ANNOUNCEMENT: Tag.VOICE_ARTIST_ANNOUNCEMENT,
    TAG_VERSION_EVENT_WISHES_NOTICE: Tag.VERSION_EVENT_WISHES_NOTICE,
    TAG_VERSION_EVENT_NOTICES_COMPILATION: Tag.VERSION_EVENT_NOTICES_COMPILATION,
    TAG_CHARACTER_DEMO: Tag.CHARACTER_DEMO,
    TAG_CHARACTER_TEASER: Tag.CHARACTER_TEASER,
    TAG_STORY_QUEST: Tag.STORY_QUEST,
    TAG_VERSION_NEW_WEAPON: Tag.VERSION_NEW_WEAPON,
    TAG_NEW_OUTFIT: Tag.NEW_OUTFIT,
    TAG_OUTFIT_TEASER: Tag.OUTFIT_TEASER,
    TAG_NEW_CONTENTS_DISPLAY: Tag.NEW_CONTENTS_DISPLAY,
    TAG_WEB_EVENT_WALLPAPERS: Tag.WEB_EVENT_WALLPAPERS,
    TAG_VERSION_PREVIEW: Tag.VERSION_PREVIEW,
    TAG_EVENT: Tag.EVENT,
    TAG_VERSION_TRAILER: Tag.VERSION_TRAILER,
    TAG_OST_ALBUM: Tag.OST_ALBUM,
    TAG_SPECIAL_PROGRAM_PREVIEW: Tag.SPECIAL_PROGRAM_PREVIEW,
    TAG_DEVELOPERS_DISCUSSION: Tag.DEVELOPERS_DISCUSSION,
    TAG_COLLECTED_MISCELLANY: Tag.COLLECTED_MISCELLANY,
    TAG_VERSION_EVENTS_PREVIEW: Tag.VERSION_EVENTS_PREVIEW,
    TAG_EVENT_TEASER: Tag.EVENT_TEASER,
    TAG_VERSION_NEW_ARTIFACT: Tag.VERSION_NEW_ARTIFACT,
    TAG_UPDATE_PREVIEW: Tag.UPDATE_PREVIEW,
    TAG_UPDATE_DETAILS: Tag.UPDATE_DETAILS,
    TAG_LEY_LINE_OVERFLOW: Tag.LEY_LINE_OVERFLOW,
    TAG_WALLPAPERS: Tag.WALLPAPERS,
    TAG_GENIUS_INVOKATION_TCG: Tag.GENIUS_INVOKATION_TCG,
    TAG_CUTSCENE_ANIMATION: Tag.CUTSCENE_ANIMATION,
    TAG_GENSHIN_CONCERT: Tag.GENSHIN_CONCERT_2023,
    TAG_VERSION_PREVIEW_PAGE: Tag.VERSION_PREVIEW_PAGE,
    TAG_MUSIC: Tag.MUSIC,
}


def get_tags_from_subject(subject: str) -> set[Tag]:
    tags = set()
